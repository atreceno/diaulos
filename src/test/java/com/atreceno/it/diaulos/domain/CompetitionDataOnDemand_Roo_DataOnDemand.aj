...
privileged aspect CompetitionDataOnDemand_Roo_DataOnDemand {
    ...
    public void CompetitionDataOnDemand.setCode(Competition obj, int index) {
    ...
    public void CompetitionDataOnDemand.setDescription(Competition obj, int index) {
    ...
    public void CompetitionDataOnDemand.setFinishDate(Competition obj, int index) {
    ...
    public void CompetitionDataOnDemand.init() {
        int from = 0;
        int to = 10;
        data = Competition.findCompetitionEntries(from, to);
        if (data == null) {
